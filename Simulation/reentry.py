...
list_of_objects = [earth, point_ActualSD, point_IP, point_KSC, capsule] # List containing objects of interest for animation
...
capsule.p = 0 # Air density (initially 0 due to capsule being in space)
...
print("START")
while t<tf: # While the time variable t is less than 
    rate(fps)
    ...
    capsule.p = ATMOSPHERE_1976(capsule.pos.mag-r_E).rho
